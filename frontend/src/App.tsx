...
import LeavesAnalysisSetupPage from './contrib/leaves-analysis/LeavesAnalysisSetupPage';
import LeavesAnalysisResultsPage from './contrib/leaves-analysis/LeavesAnalysisResultsPage';
      ...
      <div className="flex overflow-hidden bg-white pt-16">
        ...
        <div className="relative h-full w-full overflow-y-auto bg-gray-50 lg:ml-64">
          <Routes>
            ...
            <Route path="/leaves-analysis">
              <Route element={<LeavesAnalysisSetupPage />} path="" />
              <Route element={<LeavesAnalysisResultsPage />} path="results" />
            </Route>
